<div class="btn-group">
    ...
    @else
        <button type="button" class="btn btn-default btn-sm edit_ppmp_subaccount_btn" data="{{$data->slug}}" data-toggle="modal" data-target="#edit_ppmp_subaccount_modal" title="" data-placement="left" data-original-title="Edit">
            <i class="fa fa-edit"></i>
        </button>
    @endif
