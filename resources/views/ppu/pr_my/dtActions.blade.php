<div class="btn-group">
    ...
    <a class="btn btn-default btn-sm print_pr_btn" data="{{$pr->slug}}" target="popup" href="{{route('dashboard.my_pr.print',$pr->slug)}}"title="" data-placement="left" data-original-title="Print">
