...
@section('email-content')
    <p style="font-weight: normal; font-size: 14px">
        A <strong>Purchase Order (PO)</strong> for your <strong>{{$prOrJr->ref_book}} No. {{$prOrJr->ref_no}}</strong> has been created.
    </p>
    <hr>
    <small style="color: #4289fc">Purchase Order (PO) Details:</small>
    <table class="details-table" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        ...
        <tr>
            ...
            <td class="td-style">
                <p style="margin: 0;" class="bold">{{$po->ref_no}}</p>
            </td>
        </tr>
{{--        <tr>--}}
{{--            <td class="td-style">--}}
