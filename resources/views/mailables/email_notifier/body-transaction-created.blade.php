...
@section('email-content')
    <p style="font-weight: normal; font-size: 14px">
        <strong>{{\App\Swep\Helpers\Arrays::acronym($transaction->ref_book)}} created. {{$transaction->ref_book}} No: {{$transaction->ref_no}}</strong></p>
    <hr>
    ...
    <table id='details' border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        ...
        <tr>
            ...
            <td class="td-style">
                <p style="margin: 0;" class="bold">{{$transaction->created_at}}</p>
            </td>
        </tr>
        <tr>
